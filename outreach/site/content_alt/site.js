 ...
 * onafhankelijkheid/waarom/contact als verborgen pagina's via de
 * footer-nav. Vragen-pagina is geschrapt; vragen staan nu onderaan
 * de drie ring-pagina's en op stand-van-zaken (algemeen). Contact
 * is een aparte pagina met stub-mail, alleen bereikbaar via footer.
 *
...
window.ONDERLING_SITE = {
  ...
  footerNav: [
    ...
    { key: "onafhankelijkheid", label: "Onafhankelijk blijven", href: "onafhankelijkheid.html" },
