/* werk.js — sectie 3: Werk & maatschappij. Gemeente = doorlopend
   ...
   commercieel/e-mail. Nu met data-items-model en FAQ onderaan.
   Kruislink onafhankelijkheid + techniek-werk. */
  ...
  blocks: [
    {
      ...
      lead:
        ...
        "veilige versie. Hier zit een onafhankelijke partij tussen, " +
        "en dat verandert wat je durft te zeggen."
    },
...

    {
      ...
      paragraphs: [
        ...
        "geval. Daarom zit er een onafhankelijke partij tussen die de " +
        "verwerking doet en die niet aan de gemeente verantwoording " +
        "schuldig is voor de inhoud. Hoe die onafhankelijkheid " +
        "bedoeld is te borgen — en wat daarvan nog plan is — staat " +
        "op [onafhankelijk blijven](onafhankelijkheid.html). De " +
        "werking stap voor stap staat op [hoe werkt het]" +
        "(hoe-het-werkt.html); hoe de keten technisch in elkaar zit " +
        "op [werk en maatschappij, technisch gezien]" +
        "(techniek-werk.html)."
      ]
    },

    {
      ...
      intro:
        ...
        "elk met een eigen onafhankelijke ontvanger:",
      items: [
      ...
      items: [
        {
          ...
          a: "Twee dingen. Eén: jouw inbreng wordt in één keer " +
             ...
             "bijdragen. En daar bovenop doet een onafhankelijke " +
