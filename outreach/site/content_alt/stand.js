/* stand.js — Stand van zaken & voortgang. Nu met expliciete
   schaal-vermelding (solo, parttime) en bijgewerkte timeline. */
  ...
  blocks: [
      ...
      items: [
        ...
        },
        {
          ...
          body:
            ...
            "het onafhankelijk kan, wat het juridisch en " +
        ...
        },
        {
          period: "Verderop",
          status: "later",
          heading: "Breder bouwen en de onafhankelijke vorm",
          body:
            "De uitgewerkte toepassingen daadwerkelijk bouwen en " +
            "uitproberen, en de onafhankelijke organisatie eromheen " +
            "vormgeven (zie [onafhankelijk blijven]" +
            "(onafhankelijkheid.html)). Hangt af van wat de eerdere " +
            "stappen laten zien."
        }
      ]
    },

    {
      ...
      paragraphs: [
        ...
        "buurt of dorp dat iets wil proberen, een onafhankelijke " +
        "organisatie die een doelgroep echt kent. Eén goede partner " +
        "kan veel in beweging zetten; daarom worden de binnenste " +
        "ringen eerst afgemaakt, zodat die partner zorgvuldig " +
        "gekozen kan worden in plaats van uit nood."
      ]
    },

    {
      ...
      list: [
        ...
        "welke vorm de onafhankelijke organisatie precies krijgt."
      ]
    },
      ...
      items: [
        ...
        },
        {
          ...
          a: "Dat is in de opzet voorzien. Jouw gegevens staan in " +
             ...
             "draaien. Dat is geen losse belofte; het is hoe het in " +
             "elkaar zit."
        },
        {
          q: "Is dit open source?",
          a: "De code is open en de standaarden waarop het rust " +
             "(zoals Solid) zijn open. Een deel van het werk wordt " +
             "ondersteund door fondsen die expliciet eisen dat het " +
             "publiek beschikbaar blijft, zoals NLnet. Voor de " +
             "concrete repositories: kom over een tijdje terug, " +
             "die staan nu nog niet publiek."
        },
        {
