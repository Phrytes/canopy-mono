/* techniek.js — overzichtspagina via footer. Hier staat het hele
   model: data-items in eigen ruimtes, interfaces als vensters,
   toegangsrechten als de scheiding tussen "van mij" en "gedeeld".
   Gelaagd: eerst eenvoudig verhaal, dan glossary onderaan. */
  ...
  blocks: [
...

    {
      ...
      list: [
        ...
        "dezelfde richting wijzen. Een onafhankelijke partij doet de " +
        "eindcontrole."
      ]
    },

    {
      ...
      list: [
        ...
        "maken wat ze kunnen of zoeken; het systeem brengt vraag " +
        "en aanbod bij elkaar, zonder centrale matchmaker.",
