...
- [`TIER-C-PROPOSALS.md`](./TIER-C-PROPOSALS.md) — record of which substrate signals were **deferred** (enabledWhen / list-within-record / multi-step wizards) and the one that landed (Q27 confirm severity). Keeps the substrate's discipline durable: "wait for the second independent need before generalising."
