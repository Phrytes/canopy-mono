...
**2. Inname van ruwe berichten.** De gebruiker chat met een bot, bij voorkeur via een kanaal dat de gebruiker al gebruikt (WhatsApp Business API als hoofdspoor; Signal of een web-chat als alternatief; Telegram alleen waar de doelgroep dat dominant gebruikt). Ruwe berichten worden opgeslagen in de persoonlijke pod. Tot dit punt is de inhoud uitsluitend toegankelijk voor de gebruiker zelf.
