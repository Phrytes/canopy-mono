/**
 * B · #81 — nouns migration for basis.
 *
 * Proof that basis's DECLARED item-type surface converges with the
 ...
 *
 * NOTE — basis is the shell/unifier manifest and is deliberately EXEMPT
