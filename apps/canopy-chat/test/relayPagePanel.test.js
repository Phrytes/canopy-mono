/**
 * canopy-chat — Objective D / Surface 4 (#180): the my-data relay-URL editor
...
describe('openPagePanel — set-relay live (simple-form)', () => {
  it('opens the panel, builds the form from op.params, and shows back-to-chat', () => {
    ...
    panel.hidden = true;
    openPagePanel({
      container: panel, doc: document, op: setRelayOp, appOrigin: 'canopy-chat',
