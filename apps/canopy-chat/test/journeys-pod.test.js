/**
 * canopy-chat — pod-credential journey tests.
 *
 * The 🟡 tier from `Project Files/canopy-chat/cross-app-journey-
 ...
 *   pnpm --filter canopy-chat test journeys-pod
 *
 * # Why a separate file
 *
...
describe.skipIf(!HAS_ALICE)('CC-FO.1 — folio status (real pod)', () => {
  it.todo('TODO when wired: /folio-status reports state from Alice\'s pod-mirrored folder', async () => {
    ...
    //   2. boot canopy-chat with the SyncEngine bundle attached
