 ...
 * 2026-05-27) — lifted from `apps/canopy-chat/src/web/domAdapter.js:602`
 * so canopy-chat-mobile can surface the same `appliesTo`-gated action
 ...
 * merge as `apps/canopy-chat/src/embed.js`.
 */
