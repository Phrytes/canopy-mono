 ...
 */
import { PodCapabilityToken, Parts } from '@canopy/core';
 ...
 *
 * @param {import('@canopy/core').AgentIdentity} ownerIdentity  the pod owner (issuer/signer)
 ...
 *
 * @param {import('@canopy/core').Agent} deviceAgent  a started agent on the host's relay (hello'd)
