...
} from '../../canopy-chat/src/core/wizards/embedTimeState.js';
...
describe('Bundle F P5 — embedTimeState', () => {
  ...
  it('submitEmbedTime dispatches canopy-chat.embed-time with form values', async () => {
    const calls = [];
    ...
    expect(calls[0].origin).toBe('canopy-chat');
