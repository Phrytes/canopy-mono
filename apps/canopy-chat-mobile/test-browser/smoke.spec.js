/**
 * Phase A smoke — canopy-chat-mobile, served as Expo Web, boots in a
 ...
 *   - slash round-trip — types `/threads`, asserts the canopy-chat
...
test.describe('#224 Phase A — canopy-chat-mobile on Expo Web', () => {
