 ...
 * `apps/canopy-chat/src/v2/confirmGate.js` (consumed by both shells).
...
import { runConfirmGate, confirmRequestFromRoute, readyFromConfirm }
  from '../../../canopy-chat/src/v2/confirmGate.js';
 ...
 * @returns {(request: import('../../../canopy-chat/src/v2/confirmGate.js').ConfirmRequest) => Promise<boolean>}
 */
