/**
 * canopy-chat-mobile v2 — "Shared with me" list (RN screen, SILENT out-of-circle delivery).
 *
 * RN counterpart of web's `renderSharedWithMe` over the SAME shared selector (`buildSharedWithMe` /
 * `openSharedCopy` from the canopy-chat barrel) — web ≡ mobile by construction (invariant #2). The screen only
