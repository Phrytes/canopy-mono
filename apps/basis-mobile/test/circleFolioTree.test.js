 ...
 * exported from @onderling-app/basis) and labels folders/breadcrumbs
...
import { folioLevel, glyphForFile, formatFileSize, folioFileOpenTreatment } from '@onderling-app/basis';
...
describe('mobile folio Drive tree (folioLevel re-export)', () => {
  it('is re-exported from the basis package the screen imports', () => {
