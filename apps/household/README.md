...
| `@canopy/core` | `PodCapabilityToken` | Admin-capability flow under `src/identity/AdminCapability.js` — household admin issues capability tokens to members. | Capability-token primitive is kernel-foundational; substrates compose it, they don't wrap it. |
