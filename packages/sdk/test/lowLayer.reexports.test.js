...
describe('LOW layer — one import, explicit adapters (re-exports resolve)', () => {
  it('re-exports the kernel (@canopy/core) surface', () => {
  ...
  it('re-exports the Vault family from @canopy/vault (VaultMemory is the default)', () => {
  ...
  it('re-exports the transports from @canopy/transports', () => {
  ...
  it('re-exports a pod piece from @canopy/pod-client', () => {
