/**
 * @canopy/sdk/high — the HIGH-layer opinionated helpers.
 *
 ...
 *
 *     import { createAgent, connectSkill } from '@canopy/sdk/high';
 *
 * These re-export the existing helper modules unchanged; the main barrel
 * re-exports this slice, so `import { createAgent } from '@canopy/sdk'` is
 * identical.
 */
