 ...
 * │ implements to stay compatible with the @onderling SDK. Unlike Transport/          │
 ...
 * │ `@onderling/agent-registry`. Prove conformance with                              │
 ...
 * `@onderling/agent-registry` (forthcoming) — that substrate reads the
 ...
 * never imports `@onderling/agent-registry`. Apps + facades wire the
